...
namespace API_SystemSekolah.Controllers
{
    ...
    public class AccountSiswaController : ControllerBase
    {
        ...
        public ActionResult ChangePassword(LoginSiswaViewModel login, string baru)
        {
            try
            {
                var data = account.ChangePassword(login, baru);
                if (data == null)
                {
                    return Ok(new
                    {
        ...
        public ActionResult ForgotPassword(LoginSiswaViewModel login, string baru)
        {
            try
            {
                var data = account.ForgotPassword(login, baru);
                if (data == null)
                {
                    return Ok(new
                    {
